...
String urlRegExp =
    r'\b((https?:\/\/)?(www\.)?(((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])|([a-zA-Z0-9-]{1,63}\.)+[a-zA-Z]{2,6}|localhost)(:(6553[0-5]|655[0-2]\d|65[0-4]\d{2}|6[0-4]\d{3}|[1-5]?\d{1,4}))?((\/[-a-zA-Z0-9@:%_\+.~#?&\/\/=]*)?(\?[^\s]*)?)?)\b';
